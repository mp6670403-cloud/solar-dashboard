...
const INITIAL_PROJECTS = [
  ...
  },
  {
    ...
    conversation_logs: [
      { date: '2026-06-14', type: 'Call', recording_link: 'http://rec.solarsynergy.in/c-vikram-99', summary: 'Called to verify downpayment receipt status. Payment received.', transcript: 'Agent: Sir downpayment ₹1.1L check clear ho gaya hai, registration workflow lock kar diya hai. Client: Okay, file forward kar dena.' }
    ]
  },
  {
    id: 'B2C-1005',
...
export default function B2CProjectModule({ user }) {
  ...
  const handleAddLog = (e) => {
    ...
    const newLog = {
      ...
      type: newLogType,
      recording_link: newLogType === 'Call' ? `http://rec.solarsynergy.in/c-new-${Math.floor(100+Math.random()*900)}` : null,
